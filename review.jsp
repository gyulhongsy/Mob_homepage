...
<img src="review_img/line.png" width="100%"><br>
<p class="question">"저를 극도로 게으르게 만드는 유령이 있는 것 같아요. 
	제 잘못일리가 없어요, 도와주세요!"</p>
<p class="answer">이것은 심각한 문제로 보입니다. 저를 만나러 오신다면 이 레이겐이 
	당신을 확실하게 도울 수 있겠으나, 이 문제는 고급 엑소시즘 기술이 필요할 수 있습니다!</p>
<p class="review">-> 역시 모든 문제는 귀신 탓이였군요... 정말 확실하게 해결되었어요, 감사해요 레이겐씨!</p>
<p>&nbsp;</p></td>
</tr>
<tr>
<td class="star"><img src="review_img/star.png" width="100%"></td>
...
<td colspan="3" class="text">
<img src="review_img/line.png" width="100%"><br>
<p class="question">"지금 비디오 게임을 할 때마다 계속 지고있어요,
	이건 분명 TV가 귀신에게 홀린거에요!!!"</p>
<p class="answer">맞습니다, 아주 무시무시한 문제를 금방 발견해서 다행입니다! 저에게 바로 연락해주시면 
	신속히 해결 가능합니다. 지금 바로 의뢰서 작성하러 가세요! 1분도 걸리지 않습니다.</p>
<p class="review">-> 상담도 자세하고 일처리가 빨라서 좋았습니다!!! TV도 정신을 차려서 좋네요!</p>
<p>&nbsp;</p></td>
</tr>
<tr>
<td class="star"><img src="review_img/star.png" width="100%"></td>
...
<td colspan="3" class="text">
<img src="review_img/line.png" width="100%"><br>
<p class="question">"누군가에게 매우 크고 강한 손의 힘 때문에 더이상 작은 물건이나 
	계란을 잡을 수 없도록 만드는 저주가 있나요?"</p>
<p class="answer">죄송합니다만, 저희는 저주와 관련된 상담은 받지 않고 있습니다. 
	더 큰 계란을 사보는 것은 고려해보셨나요?</p>
<p class="review">-> 아니요, 그런 생각은 못해봤는데.. 한 번 해볼게요! 친절한 답변 고맙습니다.</p>
<p>&nbsp;</p></td>
</tr>
<tr>
<td class="star"><img src="review_img/star.png" width="100%"></td>
...
<td colspan="3" class="text">
<img src="review_img/line.png" width="100%"><br>
<p class="question">"내 은행 계좌는 사악한 돈 귀신에 홀려 있어, 도대체 있던 것들이 다 어디로 가는 거야?!"</p>
...
<td colspan="3" class="text">
<img src="review_img/line.png" width="100%"><br>
<p class="question">"효과가 있는지 모르겠어요.. 약 2주 전에 집에서 엑소시즘을 했는데도
	밤에 이상한 쿵쿵 소리가 들려요, 위험한 건가요?!"</p>
<p class="answer">글만으로는 판단하기가 어렵네요, 이번주 내로 저희 사무실을 방문하신다면
	문제가 있는지 바로 방문하여 확인이 가능합니다!</p>
<p class="review">-> 이렇게 쉽게 해결될 줄 몰랐어요, 정말 유능하신 분이네요. 다음에도 믿고 맡길게요!</p>
<p>&nbsp;</p></td>
</tr>
<tr>
<td class="star"><img src="review_img/star.png" width="100%"></td>
...
<p class="answer">아무한테도 전화할 필요 없습니다! 그런 상황을 위해 존재하는 것이 
	이 웹사이트입니다!! 이 사이트를 활용한다면 어떤 일이든 금방 해결될 것입니다.</p>
